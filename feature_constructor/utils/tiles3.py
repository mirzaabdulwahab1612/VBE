...
def tiles_nohash(size, numtilings, numtiles, numobs, floats):
    ...
    for tiling in range(numtilings):
        ...
        for q in qfloats:
            ...
            b += tilingX2
        feature = size*tiling
        for i in range(numobs,0,-1):
            offset = np.power(numtiles,i-1)
            feature += offset*coords[numobs-i]
...
def tiles(ihtORsize, numtilings, floats, ints=[], readonly=False):
    ...
    # print(f"floats: {floats} , Tiles: {Tiles}")
    return Tiles
