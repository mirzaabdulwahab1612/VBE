...
class BootstrappedDqn():
  ...
  def __init__(
    ...
    # self._optimizer = snt.optimizers.RMSProp(learning_rate=self.learning_rate, decay=0.999, momentum=0, epsilon=1e-08)
    # self._optimizer = snt.optimizers.SGD(learning_rate=self.learning_rate)
    # self._optimizer = snt.optimizers.Momentum(learning_rate=self.learning_rate, momentum=0.9, use_nesterov=False, name=None)
