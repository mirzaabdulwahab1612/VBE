...
class SARSA():
    ...
    def __init__(self, params):
        ...
        self.rnd_target = LinearNet(self.feature_dim, self.num_rvecs, bias=False)
        self.rnd_pred = LinearNet(self.feature_dim, self.num_rvecs, bias=False)
        ...
        net_params = list(self.intrinsic_wvec.parameters()) + list(self.rnd_pred.parameters())
        # Optimizer
